...
exports.getRandomRAEventArtistTrack = void 0;
...
const puppetRequest = async (page, url, cssSelector) => {
    ...
    const pageText = node_html_parser_1.parse(html);
...
const fetchRandomEventArtist = async (page, eventArtistLinks) => {
...
const getRandomRAEventArtistTrack = async (location, date, page) => {
    try {
        if (!location)
            location = 'berlin';
        ...
        while (ramda_1.isEmpty(artistLinks)) {
        ...
        if (!randomEventArtistSoundcloudLink) {
            return exports.getRandomRAEventArtistTrack(location);
        }
        /**
         * Soundcloud scrape
         */
        const scClientId = 'fSSdm5yTnDka1g0Fz1CO5Yx6z0NbeHAj';
        const scPageString = await axios_1.default.get(`${randomEventArtistSoundcloudLink}/tracks/`);
...
exports.getRandomRAEventArtistTrack = getRandomRAEventArtistTrack;
...
//# sourceMappingURL=raScraper%20copy.js.map